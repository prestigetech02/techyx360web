...
import { recordPifApplicationPayment } from "@/lib/crm/record-training-payment"
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const payment = await recordPifApplicationPayment(id, {
      amount,
      paidAt,
      method: methodValue,
      reference,
    ...
    console.error("Failed to record PIF application payment", error)
