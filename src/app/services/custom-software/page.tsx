...
const currentHref = "/services/custom-software"
...
const whatWeBuild = [
  {
    ...
    description: "Centralize and simplify your operations.",
  ...
  },
  {
    ...
    description: "Connect your tools, platforms, and data seamlessly.",
    icon: Plug,
  },
]

export const metadata: Metadata = createPageMetadata({
  title: "Custom Software Development Services | Techyx360 Technologies",
  description:
    "Custom software development solutions tailored to your business. Automate processes, improve efficiency, and scale with confidence using Techyx360 Technologies.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      <ServicePageHero
        ...
        breadcrumbLabel="Custom Software Solution"
        path="/services/custom-software"
      />
            ...
            <div className="flex flex-col gap-10 lg:gap-12">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  We develop custom software solutions that streamline operations,
                  automate workflows, and help businesses scale with confidence.
                </p>
              ...
              <div className="rounded-3xl border border-brand/20 bg-gradient-to-br from-brand/10 via-brand/5 to-transparent p-6 sm:p-8">
                <h3 className="text-xl font-bold tracking-tight text-zinc-900 sm:text-2xl dark:text-foreground">
                  Need Software That Works Your Way?
                </h3>

                <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                  Let&apos;s build a solution that helps your business operate
