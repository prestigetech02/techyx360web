...
const currentHref = "/services/mobile-app-development"
...
const offeredServices = [
  {
    ...
    description: "Modern Android apps built for performance.",
    icon: Smartphone,
  },
  {
    title: "iOS Development",
    description: "Seamless experiences for iPhone and iPad users.",
    icon: TabletSmartphone,
  },
  {
    title: "Cross-Platform Apps",
    description: "One app that works across multiple devices.",
    icon: Layers,
  },
  {
    title: "App Maintenance",
    description: "Updates, improvements, and ongoing support.",
    icon: Settings,
  },
]

export const metadata: Metadata = createPageMetadata({
  title: "Mobile App Development Services | Techyx360 Technologies",
  description:
    "Professional mobile app development services for Android, iOS, and cross-platform solutions. Build secure, scalable, and user-friendly mobile applications with Techyx360 Technologies.",
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[6fr_3fr]">
            <div className="flex flex-col gap-10 lg:gap-12">
              <div className="relative h-[320px] w-full overflow-hidden rounded-3xl sm:h-[420px] lg:h-[460px]">
                <Image
                  src={sideImage}
                  alt="Mobile application development workflow"
                  fill
              ...
              <div className="max-w-2xl">
                <h2 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl lg:text-4xl dark:text-foreground">
                  Build Mobile Apps That Drive Growth
                </h2>

                <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  We create fast, scalable, and user-friendly mobile applications
                  for startups, businesses, and enterprises.
                </p>

                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                  <BrandCtaButton href="/contact">Start Your Project</BrandCtaButton>
                  <Link
                    href="/contact"
                    className={cn(
              ...
              {servicesMenu.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Icon swap on hover: up-right -> right chevron */}
