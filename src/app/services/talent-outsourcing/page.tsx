...
import {
  RequestTalentDialog,
  RequestTalentDialogButton,
  RequestTalentDialogProvider,
} from "@/components/services/request-talent-dialog"
...
const currentHref = "/services/talent-outsourcing"
...
const offeredServices = [
  {
    ...
    description:
      "Embed skilled frontend, backend, and full-stack engineers into your product or delivery team.",
    icon: Code2,
  },
  {
    title: "Design & Product Talent",
    description:
      "Access UI/UX designers, product specialists, and digital creatives when you need them.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Team Augmentation",
    description:
      "Scale your in-house capacity for launches, migrations, and peak delivery periods.",
    icon: Users,
  },
  {
    title: "Managed Talent Placement",
    description:
      "We source, screen, and support talent so you focus on outcomes—not hiring overhead.",
    icon: UserRoundCheck,
  },
]

export const metadata: Metadata = createPageMetadata({
  title: "Talent Outsourcing Services | Techyx360 Technologies",
  description:
    "Outsource vetted tech talent with Techyx360. Get dedicated developers, designers, and specialists embedded in your team across Nigeria.",
  path: "/services/talent-outsourcing",
  keywords: [
    "talent outsourcing",
    "tech talent outsourcing Nigeria",
...
export default function TalentOutsourcingPage() {
  return (
    <main className="flex flex-1 flex-col">
      <ServicePageHero
        title="Talent Outsourcing"
        breadcrumbLabel="Talent Outsourcing"
        path="/services/talent-outsourcing"
      />
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[6fr_3fr]">
            ...
            <div className="flex flex-col gap-10 lg:gap-12">
              <div className="relative h-[320px] w-full overflow-hidden rounded-3xl sm:h-[420px] lg:h-[460px]">
                <Image
                  src={sideImage}
                  alt="Tech talent collaborating on software delivery"
                  fill
              ...
              <div className="max-w-2xl">
                <h2 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl lg:text-4xl dark:text-foreground">
                  Scale Your Team with Vetted Tech Talent
                </h2>

                <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  We help Nigerian businesses and startups grow delivery capacity
                  with dedicated developers, designers, and specialists who plug
                  into your workflow, without the long hiring cycle.
                </p>
              ...
              <div className="rounded-3xl border border-brand/20 bg-gradient-to-br from-brand/10 via-brand/5 to-transparent p-6 sm:p-8">
                <h3 className="text-xl font-bold tracking-tight text-zinc-900 sm:text-2xl dark:text-foreground">
                  Need Reliable Talent for Your Next Project?
                </h3>

                <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                  Tell us the roles you need and we will match you with screened
