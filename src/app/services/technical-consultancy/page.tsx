...
const currentHref = "/services/technical-consultancy"
...
const offeredServices = [
  {
    ...
    description:
      "Develop a clear technology roadmap aligned with your business objectives.",
    icon: Map,
  },
  {
    title: "Digital Transformation",
    description:
      "Modernize operations and embrace technologies that improve productivity.",
    icon: RefreshCw,
  },
  {
    title: "Systems Analysis",
    description:
      "Assess existing systems and identify opportunities for improvement.",
    icon: BarChart3,
  },
  {
    title: "Technology Advisory",
    description:
      "Get expert recommendations on platforms, tools, and infrastructure.",
    icon: Lightbulb,
  },
]

export const metadata: Metadata = createPageMetadata({
  title: "Technical Consultancy Services | Techyx360 Technologies",
  description:
    "Professional technical consultancy services to help businesses make smarter technology decisions, optimize operations, and drive digital transformation.",
  ...
  return (
    <main className="flex flex-1 flex-col">
      <ServicePageHero
        ...
        breadcrumbLabel="Technical Consultancy"
        path="/services/technical-consultancy"
      />
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[6fr_3fr]">
            <div className="flex flex-col gap-10 lg:gap-12">
              <div className="relative h-[320px] w-full overflow-hidden rounded-3xl sm:h-[420px] lg:h-[460px]">
                <Image
                  src={sideImage}
                  alt="Technical consultancy and business strategy session"
                  fill
              ...
              <div className="max-w-2xl">
                <h2 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl lg:text-4xl dark:text-foreground">
                  Expert Technology Guidance for Smarter Business Decisions
                </h2>

                <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  We help businesses align technology with their goals through
                  strategic consulting, digital transformation planning, and
                  expert technical advisory services.
                </p>

                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                  <BrandCtaButton href="/contact">
              ...
              <div className="rounded-3xl border border-brand/20 bg-gradient-to-br from-brand/10 via-brand/5 to-transparent p-6 sm:p-8">
                <h3 className="text-xl font-bold tracking-tight text-zinc-900 sm:text-2xl dark:text-foreground">
                  Need Expert Guidance for Your Next Technology Project?
                </h3>

                <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                  Let our consultants help you make informed decisions and
