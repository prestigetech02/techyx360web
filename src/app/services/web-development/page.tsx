...
import {
  RequestWebServiceDialog,
  RequestWebServiceDialogButton,
  RequestWebServiceDialogProvider,
} from "@/components/services/request-web-service-dialog"
...
const currentHref = "/services/web-development"
...
const offeredServices = [
  {
    ...
    description:
      "Professional websites designed to represent your brand and services.",
    icon: Globe,
  },
  {
    title: "E-Commerce Development",
    description:
      "Online stores built for seamless shopping experiences and sales growth.",
    icon: ShoppingCart,
  },
  {
    title: "Custom Web Applications",
    description:
      "Tailored web solutions designed around your unique business needs.",
    icon: Code2,
  },
  {
...
export const metadata: Metadata = createPageMetadata({
  title: "Web Development Services | Techyx360 Technologies",
  description:
    "Professional web development services for businesses. We build fast, responsive, SEO-friendly websites and custom web applications that drive growth.",
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <nav aria-label="Breadcrumb" className="mt-5">
            <ol className="inline-flex max-w-full flex-nowrap items-center gap-1.5 whitespace-nowrap rounded-full border border-white/10 bg-white/10 px-3 py-1.5 text-xs text-white/70 backdrop-blur-sm sm:gap-2 sm:px-4 sm:py-2 sm:text-sm">
              ...
              <li className="font-semibold text-white">Web Development</li>
            </ol>
          </nav>
        </div>
      </section>
            ...
            <div className="flex flex-col gap-10 lg:gap-12">
              ...
              <div className="max-w-2xl">
                <h2 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl lg:text-4xl dark:text-foreground">
                  Websites Built to Perform and Convert
                </h2>

                <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  We design and develop modern, responsive websites that help
                  businesses establish credibility, attract customers, and drive
                  growth.
                </p>
              ...
              <div className="rounded-3xl border border-brand/20 bg-gradient-to-br from-brand/10 via-brand/5 to-transparent p-6 sm:p-8">
                ...
                <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                  Let&apos;s create a powerful online presence that helps you
